    ...
    return (
        ...
        <section id="about" className="w-full px-4 sm:px-10 lg:px-[12%] py-25 scroll-mt-2 bg-white text-slate-800">
            ...
            <div className="text-center mb-12">
                ...
                <h2 className="text-2xl sm:text-4xl font-bold mt-2">About Me</h2>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-14">
                ...
                <div className="flex-1">
                    ...
                    <p className="mb-10 max-w-2xl font-mono text-base sm:text-lg leading-relaxed text-slate-700">
                    ...
                    <h4 className="text-xl font-semibold text-slate-800 mt-10 mb-4">Tools</h4>
