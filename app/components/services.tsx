    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-12">
                ...
                <h2 className="text-2xl sm:text-4xl font-bold mt-2">My Services</h2>
            ...
            >
                {serviceData.map(({ icon, title, description, link }, index) => (
                    ...
                    <div
                        ...
                        hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group hover:bg-green-100"
                    >
                        ...
                        <a
                            href={link}
                            className="inline-flex items-center gap-2 text-sm mt-5 text-green-600 hover:text-green-700 font-medium transition-colors"
                        >
