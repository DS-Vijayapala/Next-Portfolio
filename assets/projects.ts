...
export const Projects = [
...

    {
        ...
        description:
         ...
         and oversee basic HR functions. Includes authentication, dynamic job listings, 
         admin dashboard, and RESTful APIs. Built with scalability and modularity in mind.`,
        bgImage:
